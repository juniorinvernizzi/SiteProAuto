...
export const translations = {
  pt: {
    ...
    revendedor: {
      navBtn: "SEJA UM REVENDEDOR",
      title1: "SEJA UM",
      title2: "REVENDEDOR",
      subtitle: "Faça parte da nossa rede de distribuição e leve os melhores produtos de estética automotiva até os seus clientes.",
      info1Title: "Suporte Dedicado",
      info1Text: "Equipe comercial exclusiva para revendedores Proauto",
      info2Title: "Melhores Condições",
      info2Text: "Tabela especial, prazos e condições de pagamento",
      info3Title: "Material de Apoio",
      info3Text: "Treinamentos, catálogos e suporte de marketing",
      headquarters: "Central de Revendedores",
      whatsapp: "WhatsApp Comercial",
      formTitle: "Quero ser Revendedor",
      formSubtitle: "Preencha o formulário e nossa equipe comercial entrará em contato em até 1 dia útil.",
      fullName: "Nome Completo",
      fullNamePlaceholder: "João Silva",
      ...
      segmentOptions: [
        ...
        { value: "revenda", label: "Revenda / Distribuidora" },
        { value: "supermercado", label: "Supermercado / Hipermercado" },
        { value: "ecommerce", label: "E-commerce" },
        { value: "outros", label: "Outros" }
      ],
      message: "Observações",
      messagePlaceholder: "Conte um pouco mais sobre o seu negócio...",
      send: "Quero ser Revendedor",
      successTitle: "Candidatura enviada!",
      successText: "Nossa equipe comercial entrará em contato em breve."
    }
  },
  en: {
    nav: {
    ...
    revendedor: {
      navBtn: "BECOME A RESELLER",
      title1: "BECOME A",
      title2: "RESELLER",
      subtitle: "Join our distribution network and bring the best automotive aesthetic products to your customers.",
      info1Title: "Dedicated Support",
      info1Text: "Exclusive commercial team for Proauto resellers",
      info2Title: "Best Conditions",
      info2Text: "Special pricing, terms and payment conditions",
      info3Title: "Marketing Support",
      info3Text: "Training, catalogs and marketing materials",
      headquarters: "Reseller Center",
      whatsapp: "Commercial WhatsApp",
      formTitle: "Become a Reseller",
      formSubtitle: "Fill in the form and our commercial team will contact you within 1 business day.",
      fullName: "Full Name",
      fullNamePlaceholder: "John Smith",
      company: "Company / Business Name",
      companyPlaceholder: "Your Company Ltd",
      cnpj: "Tax ID",
      cnpjPlaceholder: "Enter your tax ID",
      email: "Email",
      emailPlaceholder: "john@company.com",
      phone: "WhatsApp / Phone",
      phonePlaceholder: "+1 (555) 99999-9999",
      city: "City / State",
      cityPlaceholder: "New York, NY",
      segment: "Business Segment",
      segmentPlaceholder: "Select your segment",
      segmentOptions: [
        { value: "autocenter", label: "Auto Center" },
        { value: "estetica", label: "Auto Detailing" },
        { value: "revenda", label: "Resale / Distributor" },
        { value: "supermercado", label: "Supermarket / Hypermarket" },
        { value: "ecommerce", label: "E-commerce" },
        { value: "outros", label: "Other" }
      ],
      message: "Additional Notes",
      messagePlaceholder: "Tell us a bit more about your business...",
      send: "Become a Reseller",
      successTitle: "Application sent!",
      successText: "Our commercial team will be in touch soon."
    }
  },
  es: {
    nav: {
    ...
    revendedor: {
      navBtn: "SÉ UN REVENDEDOR",
      title1: "SÉ UN",
      title2: "REVENDEDOR",
      subtitle: "Únete a nuestra red de distribución y lleva los mejores productos de estética automotriz a tus clientes.",
      info1Title: "Soporte Dedicado",
      info1Text: "Equipo comercial exclusivo para revendedores Proauto",
      info2Title: "Mejores Condiciones",
      info2Text: "Tabla especial, plazos y condiciones de pago",
      info3Title: "Material de Apoyo",
      info3Text: "Capacitaciones, catálogos y apoyo de marketing",
      headquarters: "Central de Revendedores",
      whatsapp: "WhatsApp Comercial",
      formTitle: "Quiero ser Revendedor",
      formSubtitle: "Complete el formulario y nuestro equipo comercial lo contactará dentro de 1 día hábil.",
      fullName: "Nombre Completo",
      fullNamePlaceholder: "Juan García",
      company: "Empresa / Razón Social",
      companyPlaceholder: "Su Empresa SL",
      cnpj: "CNPJ / RFC",
      cnpjPlaceholder: "Ingrese su identificación fiscal",
      email: "E-mail",
      emailPlaceholder: "juan@empresa.com",
      phone: "WhatsApp / Teléfono",
      phonePlaceholder: "+54 (11) 9999-9999",
      city: "Ciudad / Estado",
      cityPlaceholder: "Buenos Aires, CABA",
      segment: "Segmento de Negocio",
      segmentPlaceholder: "Seleccione su segmento",
      segmentOptions: [
        { value: "autocenter", label: "Auto Center" },
        { value: "estetica", label: "Estética Automotriz" },
        { value: "revenda", label: "Reventa / Distribuidora" },
        { value: "supermercado", label: "Supermercado / Hipermercado" },
        { value: "ecommerce", label: "E-commerce" },
        { value: "otros", label: "Otros" }
      ],
      message: "Observaciones",
      messagePlaceholder: "Cuéntenos un poco más sobre su negocio...",
      send: "Quiero ser Revendedor",
      successTitle: "¡Solicitud enviada!",
      successText: "Nuestro equipo comercial se pondrá en contacto pronto."
    }
  }
};
