...
export default function BuyOnlinePage({ searchParams }: { searchParams: Promise<{ lang?: string }> }) {
    ...
    <main className="min-h-screen text-white font-sans selection:bg-accent selection:text-ink pt-32 pb-24">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <header className="mb-24 text-center">
          ...
          >
            Adquira os produtos Proauto através de nossos parceiros oficiais, seja em lojas físicas ou online.
          </motion.p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <h2 className="font-display text-4xl uppercase mb-6">Loja Online</h2>
            <p className="text-gray-400 mb-12 leading-relaxed">
              Compre com conforto e segurança através do nosso e-commerce oficial ou parceiros digitais. Entrega rápida para todo o Brasil.
            </p>
          ...
          >
            ...
            <h2 className="font-display text-4xl uppercase mb-6">Loja Física</h2>
            <p className="text-gray-400 mb-12 leading-relaxed">
              Encontre os produtos Proauto nas melhores lojas de estética automotiva, supermercados e hipermercados perto de você.
            </p>
            ...
            <div className="mt-12 w-full">
              <h3 className="text-sm font-bold uppercase tracking-widest text-gray-500 mb-6">Principais Redes</h3>
